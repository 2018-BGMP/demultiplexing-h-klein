...
### Reviewer: Garth Kong 
### Notes: my comments will marked with '###' for ease of reading. 
...
### This is an interesting way to process files via labeling them using built-in python dictionaries. Neat. 
...
### is number_quality the number of quality score lines? Is this used to double check that LN/4 = number_quality? 

# Run populate_array for later
scores_sum, NR, NQ = populate_array(file) ### Sets scores=scores_sum, LN=NR, number_quality=NQ. 

# Calculating the mean quality score 
mean_scores = scores_sum/NQ ### divides scores_sum by number of quality score lines. 
